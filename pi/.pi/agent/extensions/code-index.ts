...
const DEFAULT_CTAGS_BIN = "/opt/homebrew/bin/ctags";
const CTAGS_BIN = process.env.PI_CTAGS_BIN ?? (fs.existsSync(DEFAULT_CTAGS_BIN) ? DEFAULT_CTAGS_BIN : "ctags");

function hasCtags(): boolean {
	return path.isAbsolute(CTAGS_BIN) ? fs.existsSync(CTAGS_BIN) : true;
}
...
export default function (pi: ExtensionAPI) {
	...
	const FAIL_MSG = "Failed to build index. Is universal-ctags installed? (brew install universal-ctags, or set PI_CTAGS_BIN).";
